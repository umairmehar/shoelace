...
const ImageComparer = class {
    ...
    render() {
        return (index.h("div", { ref: el => (this.base = el), part: "base", class: "image-comparer", onKeyDown: this.handleKeyDown }, index.h("div", { class: "image-comparer__image" }, index.h("div", { part: "before", class: "image-comparer__before" }, index.h("slot", { name: "before" })), index.h("div", { part: "after", class: "image-comparer__after", style: {
            ...
            }, onMouseDown: this.handleDrag, onTouchStart: this.handleDrag }, index.h("div", { ref: el => (this.handle = el), part: "handle", class: "image-comparer__handle", role: "scrollbar", "aria-valuenow": this.dividerPosition, "aria-valuemin": "0", "aria-valuemax": "100", tabIndex: 0 }, index.h("sl-icon", { class: "image-comparer__handle-icon", name: "grip-horizontal" })))));
    }
